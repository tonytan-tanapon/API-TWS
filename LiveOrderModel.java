...
import apitest.OrdersPanel.OrderRow;

public class LiveOrderModel extends AbstractTableModel implements ILiveOrderHandler {
	...
	Object handler;
	public LiveOrderModel(AutoTradePanel autoTradePanel) {
