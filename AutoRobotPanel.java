...
public class AutoRobotPanel extends StackPanel implements INewTab {
	ATrade aTrade = new ATrade(this);
...
//	public BarDetailPanel m_barDetailPanel = new BarDetailPanel("2",DurationUnit.DAY,BarSize._1_hour,WhatToShow.MIDPOINT);
...
//	PanelData accountPanel = new PanelData(m_accountsummaryModel);
	...
	PanelData histPanel = new PanelData(aTrade.aHistorical);
	
	JFrame histFrame = new JFrame();  //create new frame for monitoring historical data
	
	
	PanelData positionPanel = new PanelData(aTrade.aPosition);
//	PanelData accountPanel = new PanelData(m_accountsummaryModel);
...
//	String tradeType= "";
	...
	AutoRobotPanel(AutoTradeBuilder autoTradeBuilder){
	...
	AutoRobotPanel( String symbol, SecType sectype, double qty, double traget, double stop, String day, BarSize barsize) {
...
//		rightPanel.add(histPanel.getScrollPane());
		...
		histFrame.add(histPanel.getScrollPane());
		histFrame.setSize(900,600);
...
//		horzPanel.add(m_chart);
		...
		histFrame.setTitle("Historical Data");
